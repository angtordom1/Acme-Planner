...
<acme:list readonly="false">
	<acme:list-column code="anonymous.work-plan.list.label.periodStart" path="periodStart" width="25%"/>
	<acme:list-column code="anonymous.work-plan.list.label.periodEnd" path="periodEnd" width="25%"/>
