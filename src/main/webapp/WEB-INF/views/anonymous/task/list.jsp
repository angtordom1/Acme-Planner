...
<acme:list readonly="false">
	...
	<acme:list-column code="anonymous.task.list.label.state" path="state" width="15%" sortable="false"/>
	<acme:list-column code="anonymous.task.list.label.finished" path="finished" width="15%" sortable="false"/>
</acme:list>