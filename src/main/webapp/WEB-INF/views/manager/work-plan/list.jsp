...
<acme:list readonly="false">
	<acme:list-column code="manager.work-plan.list.label.title" path="title" width="10%" sortable="false"/>
	...
	<acme:list-column code="manager.work-plan.list.label.finished" path="finished" width="15%" sortable="false"/>
</acme:list>