...
<acme:form>
	...
	<acme:form-submit test="${command == 'show' && finished == 'false' && workplanPublicado == 'false'}" code="manager.task.form.button.update" action="/manager/task/update"/>
	<acme:form-submit test="${command == 'show' && finished == 'false' && workplanPublicado == 'false' && ultimaTask == false}" code="manager.task.form.button.delete" action="/manager/task/delete"/>
